...
<head>
    ...
    <title>Administratorski panel | Jahorina</title>
        ...
        <div id="panel" class="small-12 columns">
            <nav>
                <ul class="main-navigation button-group radius">
                    ...
                    <li class="<?=($this->uri->segment(2)==="index")?'selected':''?>" >
                        <a class="button" href="<?php echo site_url("page/sve_stranice"); ?>">Stranice</a>
                    </li>
                    <li class="<?=($this->uri->segment(2)==="spisak_ponuda")?'selected':''?>" >
                        <a class="button" href="<?php echo site_url("admin/vijesti"); ?>">Vijesti</a>
                    </li>
                    <li class="<?=($this->uri->segment(2)==="spisak_ekskurzija")?'selected':''?>" >
                        <a class="button" href="<?php echo site_url("newyear"); ?>">Nova godina</a>
                    </li>
